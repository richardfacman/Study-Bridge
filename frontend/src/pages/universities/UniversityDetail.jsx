      ...
      <Box>
        ...
        <Box
          sx={{
            position: 'relative',
            height: 400,
            backgroundImage: `url(${uni.coverImage || '/placeholder-university.jpg'})`,
          ...
          <Container maxWidth="lg">
            <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 2 }}>
              ...
              <Stack direction="row" spacing={1}>
                ...
                <Button variant="contained" onClick={() => handleApply(uni.programs?.[0])}>
                  Apply Now
                </Button>
              </Stack>
            </Box>
              ...
              <Card sx={{ mb: 3 }}>
                <CardContent>
                  ...
                  <Button
                    ...
                    fullWidth
                    size="large"
                    onClick={() => handleApply(uni.programs?.[0])}
                  >
                    Apply Now
                  </Button>
                </CardContent>
