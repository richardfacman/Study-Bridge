...
exports.getFilterOptions = async (req, res, next) => {
  try {
    ...
    const universityTypes = await University.distinct('universityType', { isActive: true });
    const languages = await University.distinct('languageOfInstruction', { isActive: true });
    const intakes = await University.distinct('intakePeriods', { isActive: true });
...
exports.getSimilarUniversities = async (req, res, next) => {
  try {
    ...
    const similar = await University.find({
