...
exports.getAllVisaGuides = async (req, res, next) => {
  try {
    const guides = await VisaGuide.find().sort('country');
...
exports.getVisaGuideByCountry = async (req, res, next) => {
  try {
    const guide = await VisaGuide.findOne({ 
...
exports.calculateFinancialRequirements = async (req, res, next) => {
  try {
    ...
    const guide = await VisaGuide.findOne({ country });
...
exports.updateVisaGuide = async (req, res, next) => {
  try {
    const guide = await VisaGuide.findByIdAndUpdate(
      req.params.id,
      req.body,
...
exports.deleteVisaGuide = async (req, res, next) => {
  try {
    const guide = await VisaGuide.findByIdAndDelete(req.params.id);
